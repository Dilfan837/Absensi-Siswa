        ...
        <div class="card shadow border-0 bg-success text-white">
            <div class="card-body d-flex flex-column flex-md-row justify-content-between align-items-center">
                <div class="mb-3 mb-md-0">
                    <h4 class="text-white mb-1">Dashboard Karakter Kelas</h4>
                    <p class="mb-0">Pantau radar sikap gabungan siswa di kelas Anda</p>
                </div>
                
                <form action="{{ route('guru.monitoring.siswa') }}" method="GET" class="d-flex align-items-center" id="filterForm">
    ...
    <div class="col-12 mb-4">
        <div class="card shadow-sm h-100">
            <div class="card-header border-bottom">
                <h5 class="mb-0"><i class="bx bx-radar text-success me-2"></i> Kinerja Sikap Rata-Rata Kelas</h5>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <div class="text-start ps-3">
                            ...
                            <small class="text-muted d-block">Catatan: Termasuk akumulasi dari guru lain</small>
                        </div>
                    </div>
                </div>
                @else
            ...
            <div class="card-body p-2 mt-1">
                @if(isset($siswaRadarData[$siswa->id_siswa]))
                    ...
                    <div class="text-center mt-2 border-top pt-2">
                        ...
                        <a href="{{ route('guru.monitoring.siswa.detail', $siswa->id_siswa) }}" class="btn btn-xs btn-outline-primary d-block mt-2">Detail</a>
                    </div>
                @else
                    <div class="text-center py-4 text-muted small">
                        <i class="bx bx-sleep mb-1 fs-3"></i><br>
                        Siswa belum mendapat rating 
                    </div>
                @endif
            </div>
        </div>
    ...
    new Chart(ctxMain, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgba(113, 221, 55, 0.2)', // Success color faint
                borderColor: '#71dd37',
